...
boolean_t attribute_registry::contains_key(hash_t h_key) { return _attributes.contains(h_key); }
...
size_t attribute_registry::get_count() const { return _attributes.size(); }
