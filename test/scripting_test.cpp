...
TEST(scripting_text_suite, js_value_from_to_value) {
    ...
    res = engine.guarded_evaluate("val", variant::VECTOR3);
    ...
    res = engine.guarded_evaluate("val", variant::VECTOR4);
